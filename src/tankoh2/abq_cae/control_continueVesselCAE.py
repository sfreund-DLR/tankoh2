...
# ------- general    
    ...
    modelname = 'NGT-BIT-2022-02-18_Shell_10_3DShell'
    ...
    WindingOfDiffParts = False # true =  winding composed of differnt layer parts; false -- winding is one part
...
############# START
    ...
    if createUMAT == True:
        cvc.createUMATmaterials(model, layerMaterialPrefix, UMATprefix, materialPath, materialName, nDepvar, degr_fac, AbqMATinAcuteTriangles, udLayers, compositeLayup, windingPartName, userDefinedField, noSectionPoint)
    ...
    if createPeriodicBCs:
        cvc.applyPeropdicBCs(layerPartPrefix, reveloveAngle, exceptionSets, assembly, parts, model, useContact, CoordAxisWhichIsRotAxis, WindingOfDiffParts) # 
